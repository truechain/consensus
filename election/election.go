...
// This file is part of the discovery library.
//
// The discovery library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The discovery library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the discovery library. If not, see <http://www.gnu.org/licenses/>.
...
import (
	...
	"github.com/truechain/consensus"
	"github.com/truechain/discovery/common"
	"github.com/truechain/discovery/core/state"
	"github.com/truechain/discovery/core/types"
	"github.com/truechain/discovery/core/vm"
	"github.com/truechain/discovery/crypto"
	"github.com/truechain/discovery/event"
	"github.com/truechain/discovery/log"
	"github.com/truechain/discovery/params"
)
	...
	if current.Cmp(fastNumber) > 0 {
		...
		if block != nil {
			var (
				...
				backMembers []*types.CommitteeMember
			)
			for _, m := range e.fastchain.GetBlockByNumber(epoch.BeginHeight).SwitchInfos() {
				...
				if m.Flag == types.StateUnusedFlag {
					backMembers = append(backMembers, m)
				}
			}
			committee := &types.ElectionCommittee{Members: members, Backups: backMembers}
