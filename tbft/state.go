...
import (
	...
	"github.com/truechain/consensus/tbft/metrics"
	ttypes "github.com/truechain/consensus/tbft/types"
	"github.com/truechain/discovery/common/hexutil"
...
func (cs *ConsensusState) finalizeCommit(height uint64) {
	...
	if err != nil {
		log.Debug("Error on ApplyBlock. Did the application crash? Please restart discovery", "err", err)
		return
	}
	// Save to blockStore.
